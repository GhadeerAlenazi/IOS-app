...
import Foundation
import UIKit
class LGMASignup_SightedViewController: UIViewController{
...
//    @IBOutlet weak var LastName: UITextField!
    ...
    @IBAction func SigUp(_ sender: Any) {
        ...
        if (UserName.text == "" || Password.text == "" || Email.text == "") {
            ...
            let request = NSMutableURLRequest(url: NSURL(string: "http://10.6.202.57/GraduationProject/SignUp_Sighted.php")! as URL)
            ...
            /*  let alertController = UIAlertController(title: "اهلا بك", message:
             "تمت اضافتك بنجاح", preferredStyle: UIAlertController.Style.alert)
             alertController.addAction(UIAlertAction(title: "حسنا", style: UIAlertAction.Style.default,handler: nil))
...
extension LGMASignup_SightedViewController: UITextFieldDelegate {
