//
//  LGMADetailRequestViewController.swift
//  BeMySight
//
...
class LGMADetailRequestViewController: UIViewController {
...
//        let serviceURL = URL(string:"http://localhost/GraduationProject/RejectRequest.php");
//
...
//            task.resume()
//        }
        let request = NSMutableURLRequest(url: NSURL(string: "http://10.6.202.57/GraduationProject/RejectRequest.php")! as URL)
...
//        let serviceURL = URL(string:"http://localhost/GraduationProject/accept_request.php");
//
//        // download the json data
//        var url = URLRequest(url: serviceURL!)
//       let idd = UserDefaults.standard.string(forKey:"id")
...
//
//                    //self.parseJson(data!)
//                    self.alertMessage(message: "تم قبول الطلب  ")
//                }
//                else{
//
//
...
//        }
//
        let request = NSMutableURLRequest(url: NSURL(string: "http://10.6.202.57/GraduationProject/accept_request.php")! as URL)
        //request.httpMethod = "POST"
