...
class LGMAEditViewController: UIViewController {
    
    
    @IBOutlet weak var usernameOrEmailLbl: UILabel!
    ...
    override func viewDidLoad() {
        ...
        if selectedCell == 1 {
            ...
            usernameOrEmailLbl.text = username
        } else if selectedCell == 2 {
            let email = UserDefaults.standard.string(forKey: "email")
            usernameOrEmailLbl.text = email
        }
    }
    ...
    func alertWithTF2() {
        ...
        let save = UIAlertAction(title: "حفظ", style: .default) { (alertAction) in
            ...
            let request = NSMutableURLRequest(url: NSURL(string: "http://10.6.202.57/GraduationProject/update_email.php")! as URL)
    ...
    func alertWithTF() {
        ...
        let save = UIAlertAction(title: "حفظ", style: .default) { (alertAction) in
            ...
            let request = NSMutableURLRequest(url: NSURL(string: "http://10.6.202.57/GraduationProject/update_username.php")! as URL)
            request.httpMethod = "POST"
