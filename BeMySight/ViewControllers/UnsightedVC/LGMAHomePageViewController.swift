//
//  LGMAHomePageViewController.swift
//  BeMySight
//
//  Created by غدير العنزي on 22/06/1440 AH.
//  Copyright © 1440 LGMA. All rights reserved.
//

import Foundation
import UIKit
class LGMAHomePageViewContoller: UITableViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "changeUsername" {
            let editorVC = segue.destination as! LGMAEditaccountViewController
