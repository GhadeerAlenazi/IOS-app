//
//  LGMACompletedRequestViewController.swift
//  BeMySight
//
...
import UIKit
import AVFoundation
class LGMACompletedRequestViewController: UIViewController, UITableViewDelegate, UITableViewDataSource  {
    ...
    @objc func getItem(){
        ...
        let serviceURL = URL(string:"http://10.6.202.57/GraduationProject/displayrequest_blind.php");
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "DisplayReqestCell", for: indexPath) as! DisplayRequestTableViewCell
   ...
   func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let vc = storyboard?.instantiateViewController(withIdentifier: "LGMADetailsDisplayRequest") as? LGMADetailsDisplayRequest
        let Request: ViewRequestModel
        Request = RequestList[indexPath.row]
    vc?.id = Request.id
